...
#include "ArcherAbilityTagRelationshipMapping.generated.h"

/*
 * FArcherAbilityTagRelationship
 *
 * Struct that defines the relationship between different ability tags
 */
USTRUCT()
struct FArcherAbilityTagRelationship
{
	GENERATED_BODY()
...
/*
 * UArcherAbilityTagRelationship
 *
 * Mapping of how ability tags block or cancel other abilities
 */
UCLASS()
class ARCHERGAME_API UArcherAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FArcherAbilityTagRelationship> AbilityTagRelationships;
