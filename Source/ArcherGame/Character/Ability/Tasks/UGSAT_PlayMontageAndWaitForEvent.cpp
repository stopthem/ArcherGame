...
#include "UGSAT_PlayMontageAndWaitForEvent.h"
...
UArcherAbilitySystemComponent* UGSAT_PlayMontageAndWaitForEvent::GetTargetASC()
{
	return Cast<UArcherAbilitySystemComponent>(AbilitySystemComponent);
}
...
UGSAT_PlayMontageAndWaitForEvent* UGSAT_PlayMontageAndWaitForEvent::PlayMontageAndWaitForEvent(UGameplayAbility* OwningAbility,
                                                                                               FName TaskInstanceName, UAnimMontage* MontageToPlay, FGameplayTagContainer EventTags, float Rate, FName StartSection, bool bStopWhenAbilityEnds,
...
void UGSAT_PlayMontageAndWaitForEvent::Activate()
{
	...
	UArcherAbilitySystemComponent* GSAbilitySystemComponent = GetTargetASC();
