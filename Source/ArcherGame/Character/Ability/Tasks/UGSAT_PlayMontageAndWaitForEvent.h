...
#include "UGSAT_PlayMontageAndWaitForEvent.generated.h"
 ...
 */
UCLASS()
class ARCHERGAME_API UGSAT_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
...
private:
	...
	UArcherAbilitySystemComponent* GetTargetASC();
